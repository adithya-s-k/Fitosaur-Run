...
def capture_frame_fullbody():
    ...
    cap = cv2.VideoCapture('./assets/BicepCurls.mp4')
    while(cap.isOpened()):
    ...
    # /////////////////////////////////////////////////
    time.sleep(2)
    cap = cv2.VideoCapture('./assets/HighKnees.mp4')
    while(cap.isOpened()):
    # Capture frame-by-frame
        ret, res1 = cap.read()
        if ret == True:
    ...
    time.sleep(2)
    # ///////////////////////////////////////////////
    cap = cv2.VideoCapture('./assets/ToeTouching.mp4.mp4')
    while(cap.isOpened()):
    # Capture frame-by-frame
        ret, res1 = cap.read()
        if ret == True:
    ...
    while True:
        ...
        if res.pose_landmarks and inFrame(res.pose_landmarks.landmark):
            ...
            if p[0][np.argmax(p)] > 0.75:
                cv2.putText(frm, pred , (100,100),cv2.FONT_ITALIC, 2, (0,255,255),3)
